...
Sau khi train, mô hình good fit được lưu thành \path{models/ann_heuristic_goodfit.keras}. Khi A* cần tính \(h(n)\), hệ thống chuyển trạng thái hiện tại thành vector input rồi gọi ANN để dự đoán khoảng cách còn lại.
...
Tuy vậy, thời gian chạy của A* + ANN cao hơn vì mỗi lần tính heuristic phải gọi mô hình Keras. Đây là overhead của cách demo bằng Python, không phải bằng chứng rằng ANN luôn kém về hiệu năng. Nếu triển khai batch prediction, cache mạnh hơn hoặc dùng runtime tối ưu, thời gian có thể được cải thiện.
...
\begin{itemize}
    ...
    \item Demo A* + ANN tốn thời gian do overhead gọi model nhiều lần.
...
\begin{itemize}
    ...
    \item Batch các lần dự đoán ANN hoặc cache heuristic tốt hơn để giảm thời gian chạy.
